...
export class IsEcuadorianIdentityCardConstraint implements ValidatorConstraintInterface {
...
export function IsEcuadorianIdentityCard(validationOptions?: ValidationOptions) {
